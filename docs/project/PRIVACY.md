...
ModelDock is self-hosted software. The open-source project does not include
maintainer-operated telemetry, advertising, or a hosted analytics service.

## Data Processed By A Deployment

A ModelDock operator may process:
...
ModelDock does not intentionally persist full prompts or responses in the
...
under GitHub's own policies; it is not part of the ModelDock runtime.
