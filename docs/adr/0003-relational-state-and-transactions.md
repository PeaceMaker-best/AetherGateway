...
AetherGateway uses normalized PostgreSQL tables through SQLx with Tokio, Rustls,
...
4. Retain the pre-upgrade backup according to the operator's recovery policy;
   AetherGateway never fabricates prompt content, usage, pricing, or identity facts
