...
enterprise gateway implementation. Accepted ADRs remain in the repository when
superseded so migrations and compatibility choices have an audit trail.
...
- [ADR-0004: AetherGateway gateway and CPA Provider boundary](0004-aethergateway-gateway-and-cpa-provider-boundary.md)
...
- [ADR-0008: Team gateway focus and task navigation](0008-team-gateway-focus-and-task-navigation.md)
