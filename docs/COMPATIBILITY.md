...
This matrix is the support boundary for AetherGateway v0.1.x. “Tier 1” means the
...
references its AetherGateway client key through an environment variable rather than
...
Providers require the Responses wire API. AetherGateway does not ship
