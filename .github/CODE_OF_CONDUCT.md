...
AetherGateway community a harassment-free experience for everyone, regardless of
...
They will communicate moderation reasons when appropriate.
...
[maintainer's GitHub profile](https://github.com/PeaceMaker-best). Do not publish
personal details in an issue. Reports will be reviewed promptly and kept
confidential as far as reasonably possible.

Enforcement follows the Contributor Covenant community impact guidelines:
...
2. **Warning:** a warning with consequences for continued behavior and a
   temporary restriction on interaction when needed.
3. **Temporary ban:** a temporary ban from public or private project
   interaction for a sustained or serious violation.
4. **Permanent ban:** permanent removal for a pattern of violations,
   harassment, aggression, or disparagement.
