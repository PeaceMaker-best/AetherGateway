...
pub(super) fn settings_row(state: &AppState) -> Value {
    ...
    json!({
        ...
        "rateLimits": {
            "maxConcurrentRequests": config.max_concurrent_requests,
            "maxRequestBodyBytes": config.max_request_body_bytes,
            "requestTimeoutSecs": env_u64("AETHERGATEWAY_HTTP_REQUEST_TIMEOUT_SECS", 600),
            "streamIdleTimeoutSecs": env_u64("AETHERGATEWAY_HTTP_STREAM_IDLE_TIMEOUT_SECS", 300),
        },
